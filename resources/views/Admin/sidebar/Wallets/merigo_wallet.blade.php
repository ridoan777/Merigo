<x-app-layout>
    ...
    <!-- Start Main Widgets -->
    <x-indicators.page_header_widget pageName="Merigo Wallets" />
    <!-- End Main Widgets -->
    ...
    <div class="px-6">
        ...
        <div class="">
            <form action="{{ route('backend_merigo_wallet_datatable') }}" method="POST">
                @csrf
                ...
                <table id="dataTableDisplay"
                    ...
                    <thead class="text-xs text-gray-400 uppercase bg-gray-100 rounded-t-xl">
                        <tr>
                            ...
                            <th>SN</th>
                            <th>DB ID</th>
                            <th class="max-w-24">Wallet UID</th>
    ...
    <script>
        $(function () {
            window.dataTableDisplay = $('#dataTableDisplay').DataTable({
                ...
                scrollX: true,
                ajax: {
                    url: '{{ route("backend_merigo_wallet_datatable") }}',
                    type: 'POST',
                    headers: {
                ...
                columns: [
                    ...
                    { data: 'merigo_wallet_uid', className: 'px-3 py-2 text-center', orderable: true, searchable: true },
