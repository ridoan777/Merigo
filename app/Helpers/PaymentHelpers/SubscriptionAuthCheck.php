...
class SubscriptionAuthCheck
{
	// --------------------------------------
	public static function validityGate($tierId, $serviceId)
	{
		...
		$getSubscribedUser = SubscribedUserWeb::userId(Auth::user()->id)->tierId($tierId)->serviceId($serviceId)->status(1)->first();
