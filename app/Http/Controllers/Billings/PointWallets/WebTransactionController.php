...
class WebTransactionController extends Controller
{
	...
	public function show(Bar $bar)
	{
		...
		return view('Admin.sidebar.Bars.show', compact('bar', 'users'));
	}
	...
	{
		try {
			$columns = ['id', 'bar_uid', 'bar_admin_id', 'name', 'contact', 'address', 'city', 'image', 'status', 'created_at'];
			...
			$query = Bar::select(['id', 'bar_uid', 'bar_admin_id', 'name', 'contact', 'address', 'city', 'image', 'status', 'created_at'])
